...
var updater = function () {
    ...
    document.getElementById("dve-val").innerHTML = (dve * 1e9).toPrecision(3);
    document.getElementById("da-val").innerHTML = (da * 1e9).toPrecision(3);
    document.getElementById("das-val").innerHTML = (das * 1e9).toPrecision(3);
